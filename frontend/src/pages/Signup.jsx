  ...
  return (
    <div className='bg-slate-300 h-screen flex justify-center'>
        ...
        <div className='rounded-lg bg-white w-80 text-center p-2 h-max px-4'>
            ...
            <InputBox onChange={(e)=>{setFirstName(e.target.value)}} label={"First Name"} placeholder="Jhhon"/>
            <InputBox onChange={(e)=>{setLastName(e.target.value)}} label={"Last Name"} placeholder="Baby"/>
